document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateChart() {
        ...
        const labels = ['Day 1', 'Day 7', 'Day 15', 'Day 22', 'Day 30'];

        // Mocking a curve based on the Prophet/LSTM data we have
        const points = [
            currentData.models.prophet,
            currentData.models.lstm_day7,
            (currentData.models.lstm_day1 + currentData.models.lstm_day30) / 2,
            (currentData.models.lstm_day7 + currentData.models.lstm_day30) / 2,
            currentData.models.lstm_day30
        ];
